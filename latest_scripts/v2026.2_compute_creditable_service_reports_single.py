...
# Set this to the EDIPI you want to target (string or int)
TARGET_EDIPI = "1410844580"   # <-- change as needed
...
# Lost time reasons: always treated as lost time regardless of LOST_APPLY flag
...
def main():
    ...
    # Filter to just the target EDIPI
    ...
    # ------------------------------------------------------------------
    # MERGE OVERLAPPING CREDITABLE SEGMENTS PER PERSON (for reference only)
    # ------------------------------------------------------------------
    merged_list = []
    ...
    # ------------------------------------------------------------------
    # WRITE CSV OUTPUTS (only this EDIPI)
    # ------------------------------------------------------------------
    df_detail.to_csv(OUTPUT_DETAIL, index=False)
    summary.to_csv(OUTPUT_SUMMARY, index=False)

    # ------------------------------------------------------------------
    # GENERATE TEXT REPORT FOR THIS EDIPI
    # ------------------------------------------------------------------
